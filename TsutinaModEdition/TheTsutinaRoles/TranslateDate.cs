...
namespace TheTsutinaRoles
{
    public class ModTranslation
    {
        ...
        public static void Load()
        {
            ...
            Stream stream = assembly.GetManifestResourceStream("TheTsutinaRoles.Resources.translatedate.json");
        ...
        public static Sprite getImage(string key, float pixelsPerUnit)
        {
            key = key.Replace("/", ".");
            key = key.Replace("\\", ".");
            key = "TheTsutinaRoles.Resources." + key;
            TheTsutinaRolesPlugin.Logger.LogInfo("Resources:"+key);
